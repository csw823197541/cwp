...
public class CwpResultPanel1 extends JPanel{
    ...
    private List<Crane> craneInfoList;
    private List<Hatch> hatchInfoList;

    public CwpResultPanel1(List<CwpResultInfo> cwpResultInfoList, List<Crane> craneInfoList, List<Hatch> hatchInfoList) {
...
//        g2d.fillRect(0, 0, width, height);
        ...
        int k = 0;
        for(Crane craneInfo : craneInfoList) {
            craneQuery.put(craneInfo.getCraneId(), colors[k++]);
        }
